...
class BatAlgorithm:
    ...
    def fitness(self, Rape):
        # Asumiendo que 'Rape' es una columna o variable de los datos
        return np.sum(Rape)

    def initialize(self, data_shape):
        # Inicializa las "bats" y sus velocidades
    ...
    def optimize(self):
        """
        Realiza la optimización sin necesidad de recibir 'X' e 'y' explícitamente.
        Utiliza la variable 'Rape' calculada previamente.
        """
